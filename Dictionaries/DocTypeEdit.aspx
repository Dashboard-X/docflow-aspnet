<%@ Page language="c#" Codebehind="DocTypeEdit.aspx.cs" AutoEventWireup="True" Inherits="Bip.Dictionaries.DocTypeEdit" %>
...
<HTML>
  <HEAD>
	...
	<body class=MainWindow>
		...
		<Bip:Title Title="Document Type"  id=ctrlTitle runat=server ></Bip:Title>		
<!-- #include virtual = "~/Main_Begin.inc" -->

		<div id="PageError" runat="server"></div>
		<form id="DocTypeEdit" method="post" runat="server">
			<table>
				<tr>
					<td>
