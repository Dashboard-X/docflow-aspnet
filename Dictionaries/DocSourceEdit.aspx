<%@ Page language="c#" Codebehind="DocSourceEdit.aspx.cs" AutoEventWireup="True" Inherits="Bip.Dictionaries.DocSourceEdit" %>
...
<HTML>
  ...
  <body class=MainWindow>
		...
		<Bip:Title Title="Document Source"  id=ctrlTitle runat=server ></Bip:Title>		


<!-- #include virtual = "~/Main_Begin.inc" -->

		<div id="PageError" runat="server"></div>
    <form id="DocSourceEdit" method="post" runat="server">
			<table>

				<tr>
					<td> <span class="FieldHeader"> Name </span></td>
					<td>
